...
<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 align="center" class="section-heading">Elija el día y la hora de su cita</h1>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <select name="mes">
                        ...
                        <option value="Octubre">Octbre</option>
                ...
                <br>
                <input class="btn btn-primary btn-short btn-block" type='submit' name='boton' value='Agendar'><br>
                </div>
            </div>
    </form>
